...
public class CuentaCorreo {
  ...
  private String clave = "vfzv fwpb oeaq buvi";    //Se quito la clave por seguridad
  ...
  public void enviarCorreo(String destinatario, String tituloCorreo, 
    ...
    try {
      ...
      for (int i = 0; i < archivosAdjuntos.length; i++) {
        ...
        FileDataSource source = new FileDataSource(archivosAdjuntos[i]);  
        messageBodyPart2.setDataHandler(new DataHandler(source));  
        messageBodyPart2.setFileName(archivosAdjuntos[i]);  
