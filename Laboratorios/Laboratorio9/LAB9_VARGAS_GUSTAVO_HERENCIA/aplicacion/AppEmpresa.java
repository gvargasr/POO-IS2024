...
/**
 * Clase principal de la aplicación que simula el entorno de gestión de una empresa.
 * Esta clase crea y maneja entidades como empresas, clientes, empleados y facturas,
 * además de realizar transacciones y reportes básicos.
 */
public class AppEmpresa {
  
  /**
   * Punto de entrada principal del programa. Este método simula la creación y gestión
   * de una empresa con sus clientes, empleados y transacciones comerciales como ventas
   * y servicios.
   * 
