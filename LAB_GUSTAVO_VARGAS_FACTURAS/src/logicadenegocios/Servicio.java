...
/**
 * Clase que representa un servicio, extendiendo la clase {@code Item}. Un {@code Servicio} incluye
 * detalles específicos como el técnico que lo atiende, el período de garantía en meses y los costos
 * asociados con consumibles necesarios para el servicio.
 */
public class Servicio extends Item {
   ...
   * @param precio Precio base del servicio, heredado de {@code Item}.
   * @param tecnico Técnico que atiende el servicio.
   * @param garantiaMeses Número de meses que dura la garantía del servicio.
   * @param precioConsumibles Precio de los consumibles utilizados en el servicio.
   */
   ...
   * @param tecnico
   */
  public void asignarTecnico(Empleado tecnico) {
